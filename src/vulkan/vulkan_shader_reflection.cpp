...
ShaderStage ToShaderStage(SpvReflectShaderStageFlagBits stage)
{
    switch (stage)
    {
    case SPV_REFLECT_SHADER_STAGE_VERTEX_BIT: return ShaderStage::kVertex;
    case SPV_REFLECT_SHADER_STAGE_FRAGMENT_BIT: return ShaderStage::kPixel;
    case SPV_REFLECT_SHADER_STAGE_GEOMETRY_BIT: return ShaderStage::kGeometry;
    case SPV_REFLECT_SHADER_STAGE_TESSELLATION_CONTROL_BIT: return ShaderStage::kHull;
    case SPV_REFLECT_SHADER_STAGE_TESSELLATION_EVALUATION_BIT: return ShaderStage::kDomain;
    case SPV_REFLECT_SHADER_STAGE_COMPUTE_BIT: return ShaderStage::kCompute;
    default: throw std::runtime_error("Unsupported SPIR-V shader stage");
    }
}
...
ImageFormat ToImageFormat(SpvReflectFormat format)
{
    switch (format)
    {
    case SPV_REFLECT_FORMAT_R32_SFLOAT: return ImageFormat::kR32_Float;
    case SPV_REFLECT_FORMAT_R32G32_SFLOAT: return ImageFormat::kRG32_Float;
    case SPV_REFLECT_FORMAT_R32G32B32_SFLOAT: return ImageFormat::kRGB32_Float;
    case SPV_REFLECT_FORMAT_R32G32B32A32_SFLOAT: return ImageFormat::kRGBA32_Float;
    case SPV_REFLECT_FORMAT_R32_UINT: return ImageFormat::kR32_UInt;
    case SPV_REFLECT_FORMAT_R32G32_UINT: return ImageFormat::kRG32_UInt;
    case SPV_REFLECT_FORMAT_R32G32B32_UINT: return ImageFormat::kRGB32_UInt;
    case SPV_REFLECT_FORMAT_R32G32B32A32_UINT: return ImageFormat::kRGBA32_UInt;
    case SPV_REFLECT_FORMAT_R32_SINT: return ImageFormat::kR32_SInt;
    case SPV_REFLECT_FORMAT_R32G32_SINT: return ImageFormat::kRG32_SInt;
    case SPV_REFLECT_FORMAT_R32G32B32_SINT: return ImageFormat::kRGB32_SInt;
    case SPV_REFLECT_FORMAT_R32G32B32A32_SINT: return ImageFormat::kRGBA32_SInt;
...
ShaderReflection BuildVulkanShaderReflection(std::vector<uint32_t> const& spirv)
{
    ...
    for (SpvReflectInterfaceVariable const* spv_input : inputs)
    {
        ...
        input.semantic_name = spv_input->semantic ? spv_input->semantic :
            (spv_input->name ? spv_input->name : "");
